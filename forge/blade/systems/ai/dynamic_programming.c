...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "forge.blade.systems.ai.dynamic_programming",
        "sources": [
            "dynamic_programming.pyx"
        ]
    },
    "module_name": "forge.blade.systems.ai.dynamic_programming"
}
END: Cython Metadata */
...
#define __PYX_HAVE__forge__blade__systems__ai__dynamic_programming
#define __PYX_HAVE_API__forge__blade__systems__ai__dynamic_programming
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'forge.blade.systems.ai.dynamic_programming' */
...
static __Pyx_memviewslice __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_compute_values(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_memviewslice __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_map_to_rewards(PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_max_value_direction_around(int, int, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_has_water_around(PyObject *, int, int); /*proto*/
static PyObject *__pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_inBounds(int, int, PyObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "forge.blade.systems.ai.dynamic_programming"
extern int __pyx_module_is_main_forge__blade__systems__ai__dynamic_programming;
int __pyx_module_is_main_forge__blade__systems__ai__dynamic_programming = 0;

/* Implementation of 'forge.blade.systems.ai.dynamic_programming' */
...
static const char __pyx_k_value_matrix[] = "value_matrix";
...
static PyObject *__pyx_n_s_value_matrix;
static PyObject *__pyx_n_s_values;
static PyObject *__pyx_n_s_water;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_compute_values(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_tiles, PyObject *__pyx_v_entity); /* proto */
static PyObject *__pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_2map_to_rewards(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_tiles, PyObject *__pyx_v_entity); /* proto */
static PyObject *__pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_4max_value_direction_around(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_line, int __pyx_v_column, __Pyx_memviewslice __pyx_v_value_matrix); /* proto */
...
/* "forge/blade/systems/ai/dynamic_programming.pyx":5
 * import math
 * 
...
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_1compute_values(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_compute_values(PyObject *__pyx_v_tiles, PyObject *__pyx_v_entity, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __Pyx_memviewslice __pyx_v_reward_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_nb_lines;
  int __pyx_v_nb_columns;
  double __pyx_v_gamma_factor;
  double __pyx_v_max_delta;
  __Pyx_memviewslice __pyx_v_value_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_old_value_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("compute_values", 0);

  /* "forge/blade/systems/ai/dynamic_programming.pyx":6
 * 
 * cpdef double[:,:] compute_values(tiles, entity):
 *    cdef double[:,:] reward_matrix = map_to_rewards(tiles, entity)             # <<<<<<<<<<<<<<
 *    cdef int nb_lines = len(reward_matrix[0]), nb_columns = len(reward_matrix[1])
 * 
 */
  __pyx_t_1 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_map_to_rewards(__pyx_v_tiles, __pyx_v_entity, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_v_reward_matrix = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":7
 * cpdef double[:,:] compute_values(tiles, entity):
 *    cdef double[:,:] reward_matrix = map_to_rewards(tiles, entity)
 *    cdef int nb_lines = len(reward_matrix[0]), nb_columns = len(reward_matrix[1])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2.data = __pyx_v_reward_matrix.data;
  __pyx_t_2.memview = __pyx_v_reward_matrix.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
  {
    Py_ssize_t __pyx_tmp_idx = 0;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_reward_matrix.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_reward_matrix.strides[0];
        if (__pyx_tmp_idx < 0)
...
__pyx_t_2.shape[0] = __pyx_v_reward_matrix.shape[1];
__pyx_t_2.strides[0] = __pyx_v_reward_matrix.strides[1];
    __pyx_t_2.suboffsets[0] = -1;

__pyx_t_3 = __Pyx_MemoryView_Len(__pyx_t_2); 
  __PYX_XDEC_MEMVIEW(&__pyx_t_2, 1);
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;
  __pyx_v_nb_lines = __pyx_t_3;
  __pyx_t_2.data = __pyx_v_reward_matrix.data;
  __pyx_t_2.memview = __pyx_v_reward_matrix.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_2, 0);
  {
...
__pyx_t_3 = __Pyx_MemoryView_Len(__pyx_t_2); 
  ...
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;
  __pyx_v_nb_columns = __pyx_t_3;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":9
 *    cdef int nb_lines = len(reward_matrix[0]), nb_columns = len(reward_matrix[1])
 * 
 *    cdef double gamma_factor = 0.8  # look ahead  [0, 1]             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_v_gamma_factor = 0.8;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":10
 * 
 *    cdef double gamma_factor = 0.8  # look ahead  [0, 1]
 *    cdef double max_delta = 0.01  # maximum allowed approximation             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_max_delta = 0.01;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":12
 *    cdef double max_delta = 0.01  # maximum allowed approximation
 * 
 *    cdef double[:,:] value_matrix = np.zeros((nb_lines, nb_columns), dtype=np.float64)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_nb_lines); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_nb_columns); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_7 = PyTuple_New(2); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __pyx_t_4 = 0;
  __pyx_t_6 = 0;
  __pyx_t_6 = PyTuple_New(1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float64); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_7, __pyx_n_s_dtype, __pyx_t_8) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_6, __pyx_t_7); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_8, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_v_value_matrix = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":15
 *    cdef double[:,:] old_value_matrix
 * 
 ...
 */
  __pyx_t_9 = __Pyx_PyObject_AsDouble(__pyx_n_s_inf); if (unlikely(__pyx_t_9 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
  __pyx_v_delta = __pyx_t_9;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":19
 *    cdef int line, column
 ...
 */
  while (1) {
    __pyx_t_10 = ((__pyx_v_delta > __pyx_v_max_delta) != 0);
    if (!__pyx_t_10) break;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":20
 *    cdef double max_value, current_value
 *    while delta > max_delta:
 *       old_value_matrix = np.array(value_matrix, copy=True)             # <<<<<<<<<<<<<<
 *       for line in range(nb_lines):
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_array); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = __pyx_memoryview_fromslice(__pyx_v_value_matrix, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    ...
    __Pyx_GOTREF(__pyx_t_8);
    if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_copy, Py_True) < 0) __PYX_ERR(0, 20, __pyx_L1_error)
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_7, __pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 20, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __PYX_XDEC_MEMVIEW(&__pyx_v_old_value_matrix, 1);
    __pyx_v_old_value_matrix = __pyx_t_1;
    __pyx_t_1.memview = NULL;
    __pyx_t_1.data = NULL;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":21
 *    while delta > max_delta:
 *       old_value_matrix = np.array(value_matrix, copy=True)
 *       for line in range(nb_lines):             # <<<<<<<<<<<<<<
 *          for column in range(nb_columns):
 *             max_value = float('-inf')
 */
    __pyx_t_11 = __pyx_v_nb_lines;
    __pyx_t_12 = __pyx_t_11;
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      __pyx_v_line = __pyx_t_13;

      /* "forge/blade/systems/ai/dynamic_programming.pyx":22
 *       old_value_matrix = np.array(value_matrix, copy=True)
 *       for line in range(nb_lines):
 *          for column in range(nb_columns):             # <<<<<<<<<<<<<<
 *             max_value = float('-inf')
 * 
 */
      __pyx_t_14 = __pyx_v_nb_columns;
      __pyx_t_15 = __pyx_t_14;
      for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
        __pyx_v_column = __pyx_t_16;

        /* "forge/blade/systems/ai/dynamic_programming.pyx":23
 *       for line in range(nb_lines):
 *          for column in range(nb_columns):
 *             max_value = float('-inf')             # <<<<<<<<<<<<<<
 * 
 *             if line - 1 >= 0:
 */
        __pyx_t_9 = __Pyx_PyObject_AsDouble(__pyx_kp_s_inf_2); if (unlikely(__pyx_t_9 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L1_error)
        __pyx_v_max_value = __pyx_t_9;

        /* "forge/blade/systems/ai/dynamic_programming.pyx":25
 *             max_value = float('-inf')
 * 
 *             if line - 1 >= 0:             # <<<<<<<<<<<<<<
 ...
 * 
 */
        __pyx_t_10 = (((__pyx_v_line - 1) >= 0) != 0);
        if (__pyx_t_10) {

          /* "forge/blade/systems/ai/dynamic_programming.pyx":26
 * 
 *             if line - 1 >= 0:
 *                max_value = value_matrix[line - 1][column]             # <<<<<<<<<<<<<<
 * 
 *             if line + 1 < nb_lines:
 */
          __pyx_t_17 = (__pyx_v_line - 1);
          __pyx_t_18 = __pyx_v_column;
          __pyx_t_19 = -1;
          if (__pyx_t_17 < 0) {
            __pyx_t_17 += __pyx_v_value_matrix.shape[0];
            if (unlikely(__pyx_t_17 < 0)) __pyx_t_19 = 0;
          } else if (unlikely(__pyx_t_17 >= __pyx_v_value_matrix.shape[0])) __pyx_t_19 = 0;
          if (__pyx_t_18 < 0) {
            __pyx_t_18 += __pyx_v_value_matrix.shape[1];
            if (unlikely(__pyx_t_18 < 0)) __pyx_t_19 = 1;
          } else if (unlikely(__pyx_t_18 >= __pyx_v_value_matrix.shape[1])) __pyx_t_19 = 1;
          if (unlikely(__pyx_t_19 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_19);
            __PYX_ERR(0, 26, __pyx_L1_error)
          }
          __pyx_v_max_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_17 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_18 * __pyx_v_value_matrix.strides[1]) )));
 ...
 */
        ...
        /* "forge/blade/systems/ai/dynamic_programming.pyx":28
 *                max_value = value_matrix[line - 1][column]
 * 
 *             if line + 1 < nb_lines:             # <<<<<<<<<<<<<<
 ...
 */
        __pyx_t_10 = (((__pyx_v_line + 1) < __pyx_v_nb_lines) != 0);
        if (__pyx_t_10) {

          /* "forge/blade/systems/ai/dynamic_programming.pyx":29
 * 
 *             if line + 1 < nb_lines:
 *                current_value = value_matrix[line + 1][column]             # <<<<<<<<<<<<<<
 *                if current_value > max_value:
 ...
 */
          __pyx_t_20 = (__pyx_v_line + 1);
          __pyx_t_21 = __pyx_v_column;
          __pyx_t_19 = -1;
          if (__pyx_t_20 < 0) {
            __pyx_t_20 += __pyx_v_value_matrix.shape[0];
            if (unlikely(__pyx_t_20 < 0)) __pyx_t_19 = 0;
          } else if (unlikely(__pyx_t_20 >= __pyx_v_value_matrix.shape[0])) __pyx_t_19 = 0;
          if (__pyx_t_21 < 0) {
            __pyx_t_21 += __pyx_v_value_matrix.shape[1];
            if (unlikely(__pyx_t_21 < 0)) __pyx_t_19 = 1;
          } else if (unlikely(__pyx_t_21 >= __pyx_v_value_matrix.shape[1])) __pyx_t_19 = 1;
          if (unlikely(__pyx_t_19 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_19);
            __PYX_ERR(0, 29, __pyx_L1_error)
          }
          __pyx_v_current_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_20 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_21 * __pyx_v_value_matrix.strides[1]) )));

          /* "forge/blade/systems/ai/dynamic_programming.pyx":30
 *             if line + 1 < nb_lines:
 *                current_value = value_matrix[line + 1][column]
 *                if current_value > max_value:             # <<<<<<<<<<<<<<
 *                   max_value = current_value
 * 
 */
          __pyx_t_10 = ((__pyx_v_current_value > __pyx_v_max_value) != 0);
          if (__pyx_t_10) {

            /* "forge/blade/systems/ai/dynamic_programming.pyx":31
 *                current_value = value_matrix[line + 1][column]
 *                if current_value > max_value:
 *                   max_value = current_value             # <<<<<<<<<<<<<<
 * 
 *             if column - 1 >= 0:
 */
            __pyx_v_max_value = __pyx_v_current_value;
 ...
 */
        ...
        /* "forge/blade/systems/ai/dynamic_programming.pyx":33
 *                   max_value = current_value
 * 
 *             if column - 1 >= 0:             # <<<<<<<<<<<<<<
 ...
 *                if current_value > max_value:
 */
        __pyx_t_10 = (((__pyx_v_column - 1) >= 0) != 0);
        if (__pyx_t_10) {

          /* "forge/blade/systems/ai/dynamic_programming.pyx":34
 * 
 *             if column - 1 >= 0:
 *                current_value = value_matrix[line][column - 1]             # <<<<<<<<<<<<<<
 *                if current_value > max_value:
 *                   max_value = current_value
 */
          __pyx_t_22 = __pyx_v_line;
          __pyx_t_23 = (__pyx_v_column - 1);
          __pyx_t_19 = -1;
          if (__pyx_t_22 < 0) {
            __pyx_t_22 += __pyx_v_value_matrix.shape[0];
            if (unlikely(__pyx_t_22 < 0)) __pyx_t_19 = 0;
          } else if (unlikely(__pyx_t_22 >= __pyx_v_value_matrix.shape[0])) __pyx_t_19 = 0;
          if (__pyx_t_23 < 0) {
            __pyx_t_23 += __pyx_v_value_matrix.shape[1];
            if (unlikely(__pyx_t_23 < 0)) __pyx_t_19 = 1;
          } else if (unlikely(__pyx_t_23 >= __pyx_v_value_matrix.shape[1])) __pyx_t_19 = 1;
          if (unlikely(__pyx_t_19 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_19);
            __PYX_ERR(0, 34, __pyx_L1_error)
          }
          __pyx_v_current_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_22 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_23 * __pyx_v_value_matrix.strides[1]) )));

          /* "forge/blade/systems/ai/dynamic_programming.pyx":35
 *             if column - 1 >= 0:
 *                current_value = value_matrix[line][column - 1]
 *                if current_value > max_value:             # <<<<<<<<<<<<<<
 *                   max_value = current_value
 ...
 */
          ...
          if (__pyx_t_10) {
            ...
            /* "forge/blade/systems/ai/dynamic_programming.pyx":36
 *                current_value = value_matrix[line][column - 1]
 *                if current_value > max_value:
 *                   max_value = current_value             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "forge/blade/systems/ai/dynamic_programming.pyx":38
 *                   max_value = current_value
 * 
 *             if column + 1 < nb_columns:             # <<<<<<<<<<<<<<
 *                current_value = value_matrix[line][column + 1]
 *                if current_value > max_value:
 */
        __pyx_t_10 = (((__pyx_v_column + 1) < __pyx_v_nb_columns) != 0);
        if (__pyx_t_10) {

          /* "forge/blade/systems/ai/dynamic_programming.pyx":39
 * 
 *             if column + 1 < nb_columns:
 *                current_value = value_matrix[line][column + 1]             # <<<<<<<<<<<<<<
 *                if current_value > max_value:
 *                   max_value = current_value
 */
          __pyx_t_24 = __pyx_v_line;
          __pyx_t_25 = (__pyx_v_column + 1);
          __pyx_t_19 = -1;
          if (__pyx_t_24 < 0) {
            __pyx_t_24 += __pyx_v_value_matrix.shape[0];
            if (unlikely(__pyx_t_24 < 0)) __pyx_t_19 = 0;
          } else if (unlikely(__pyx_t_24 >= __pyx_v_value_matrix.shape[0])) __pyx_t_19 = 0;
          if (__pyx_t_25 < 0) {
            __pyx_t_25 += __pyx_v_value_matrix.shape[1];
            if (unlikely(__pyx_t_25 < 0)) __pyx_t_19 = 1;
          } else if (unlikely(__pyx_t_25 >= __pyx_v_value_matrix.shape[1])) __pyx_t_19 = 1;
          if (unlikely(__pyx_t_19 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_19);
            __PYX_ERR(0, 39, __pyx_L1_error)
          }
          __pyx_v_current_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_24 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_25 * __pyx_v_value_matrix.strides[1]) )));

          /* "forge/blade/systems/ai/dynamic_programming.pyx":40
 *             if column + 1 < nb_columns:
 *                current_value = value_matrix[line][column + 1]
 *                if current_value > max_value:             # <<<<<<<<<<<<<<
 *                   max_value = current_value
 ...
 */
          ...
          if (__pyx_t_10) {
            ...
            /* "forge/blade/systems/ai/dynamic_programming.pyx":41
 *                current_value = value_matrix[line][column + 1]
 *                if current_value > max_value:
 *                   max_value = current_value             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        /* "forge/blade/systems/ai/dynamic_programming.pyx":44
 * 
 *             value_matrix[line][
 ...
 */
        ...
        __pyx_t_27 = __pyx_v_column;
        __pyx_t_19 = -1;
        if (__pyx_t_26 < 0) {
          __pyx_t_26 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_26 < 0)) __pyx_t_19 = 0;
        } else if (unlikely(__pyx_t_26 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_19 = 0;
        if (__pyx_t_27 < 0) {
          __pyx_t_27 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_27 < 0)) __pyx_t_19 = 1;
        } else if (unlikely(__pyx_t_27 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_19 = 1;
        if (unlikely(__pyx_t_19 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_19);
          __PYX_ERR(0, 44, __pyx_L1_error)
        }

        /* "forge/blade/systems/ai/dynamic_programming.pyx":43
 *                   max_value = current_value
 * 
 *             value_matrix[line][             # <<<<<<<<<<<<<<
 *                column] = reward_matrix[line][column] + gamma_factor * max_value
 ...
 */
        ...
        __pyx_t_29 = __pyx_v_column;
        __pyx_t_19 = -1;
        if (__pyx_t_28 < 0) {
          __pyx_t_28 += __pyx_v_value_matrix.shape[0];
          if (unlikely(__pyx_t_28 < 0)) __pyx_t_19 = 0;
        } else if (unlikely(__pyx_t_28 >= __pyx_v_value_matrix.shape[0])) __pyx_t_19 = 0;
        if (__pyx_t_29 < 0) {
          __pyx_t_29 += __pyx_v_value_matrix.shape[1];
          if (unlikely(__pyx_t_29 < 0)) __pyx_t_19 = 1;
        } else if (unlikely(__pyx_t_29 >= __pyx_v_value_matrix.shape[1])) __pyx_t_19 = 1;
        if (unlikely(__pyx_t_19 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_19);
          __PYX_ERR(0, 43, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_28 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_29 * __pyx_v_value_matrix.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_26 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_27 * __pyx_v_reward_matrix.strides[1]) ))) + (__pyx_v_gamma_factor * __pyx_v_max_value));
      }
    }

    /* "forge/blade/systems/ai/dynamic_programming.pyx":46
 *                column] = reward_matrix[line][column] + gamma_factor * max_value
 * 
 *       delta = np.nanmax(             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_nanmax); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 46, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":47
 * 
 *       delta = np.nanmax(
 *          np.abs(np.subtract(old_value_matrix, value_matrix)))             # <<<<<<<<<<<<<<
 *    return value_matrix
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_abs); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_GetModuleGlobalName(__pyx_t_30, __pyx_n_s_np); if (unlikely(!__pyx_t_30)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_30);
    __pyx_t_31 = __Pyx_PyObject_GetAttrStr(__pyx_t_30, __pyx_n_s_subtract); if (unlikely(!__pyx_t_31)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_31);
    __Pyx_DECREF(__pyx_t_30); __pyx_t_30 = 0;
    __pyx_t_30 = __pyx_memoryview_fromslice(__pyx_v_old_value_matrix, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_30)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_30);
    __pyx_t_32 = __pyx_memoryview_fromslice(__pyx_v_value_matrix, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_32)) __PYX_ERR(0, 47, __pyx_L1_error)
    ...
    if (PyFunction_Check(__pyx_t_31)) {
      PyObject *__pyx_temp[3] = {__pyx_t_33, __pyx_t_30, __pyx_t_32};
      __pyx_t_7 = __Pyx_PyFunction_FastCall(__pyx_t_31, __pyx_temp+1-__pyx_t_11, 2+__pyx_t_11); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 47, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_31)) {
      PyObject *__pyx_temp[3] = {__pyx_t_33, __pyx_t_30, __pyx_t_32};
      __pyx_t_7 = __Pyx_PyCFunction_FastCall(__pyx_t_31, __pyx_temp+1-__pyx_t_11, 2+__pyx_t_11); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 47, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_33); __pyx_t_33 = 0;
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_30); __pyx_t_30 = 0;
      __Pyx_DECREF(__pyx_t_32); __pyx_t_32 = 0;
    ...
    #endif
    {
      __pyx_t_34 = PyTuple_New(2+__pyx_t_11); if (unlikely(!__pyx_t_34)) __PYX_ERR(0, 47, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_34);
      if (__pyx_t_33) {
        __Pyx_GIVEREF(__pyx_t_33); PyTuple_SET_ITEM(__pyx_t_34, 0, __pyx_t_33); __pyx_t_33 = NULL;
      }
      __Pyx_GIVEREF(__pyx_t_30);
      PyTuple_SET_ITEM(__pyx_t_34, 0+__pyx_t_11, __pyx_t_30);
      __Pyx_GIVEREF(__pyx_t_32);
      PyTuple_SET_ITEM(__pyx_t_34, 1+__pyx_t_11, __pyx_t_32);
      __pyx_t_30 = 0;
      __pyx_t_32 = 0;
      __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_31, __pyx_t_34, NULL); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 47, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
    ...
    __pyx_t_8 = (__pyx_t_31) ? __Pyx_PyObject_Call2Args(__pyx_t_4, __pyx_t_31, __pyx_t_7) : __Pyx_PyObject_CallOneArg(__pyx_t_4, __pyx_t_7);
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":48
 *       delta = np.nanmax(
 *          np.abs(np.subtract(old_value_matrix, value_matrix)))
 *    return value_matrix             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __PYX_INC_MEMVIEW(&__pyx_v_value_matrix, 0);
  __pyx_r = __pyx_v_value_matrix;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.compute_values", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  ...
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_reward_matrix, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_value_matrix, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_old_value_matrix, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_1compute_values(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_1compute_values(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_tiles = 0;
  PyObject *__pyx_v_entity = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("compute_values (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_tiles,&__pyx_n_s_entity,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_tiles)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_entity)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_values", 1, 2, 2, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compute_values") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_tiles = values[0];
    __pyx_v_entity = values[1];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("compute_values", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.compute_values", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_compute_values(__pyx_self, __pyx_v_tiles, __pyx_v_entity);
...
static PyObject *__pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_compute_values(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_tiles, PyObject *__pyx_v_entity) {
  ...
  __pyx_t_1 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_compute_values(__pyx_v_tiles, __pyx_v_entity, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 5, __pyx_L1_error)
...
/* "forge/blade/systems/ai/dynamic_programming.pyx":50
 *    return value_matrix
 * 
 * cpdef double[:,:] map_to_rewards(tiles, entity):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_3map_to_rewards(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_map_to_rewards(PyObject *__pyx_v_tiles, PyObject *__pyx_v_entity, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_lava_reward;
  double __pyx_v_stone_reward;
  double __pyx_v_water_reward;
  double __pyx_v_enemy_reward;
  double __pyx_v_forest_reward;
  double __pyx_v_scrub_reward;
  double __pyx_v_around_water_reward;
  int __pyx_v_line;
  int __pyx_v_column;
  PyObject *__pyx_v_tile_val = 0;
  __Pyx_memviewslice __pyx_v_reward_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_v_tile_line = NULL;
  __Pyx_memviewslice __pyx_r = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  ...
  __Pyx_RefNannySetupContext("map_to_rewards", 0);

  /* "forge/blade/systems/ai/dynamic_programming.pyx":55
 *    cdef str tile_val
 * 
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_AsDouble(__pyx_kp_s_inf_2); if (unlikely(__pyx_t_1 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 55, __pyx_L1_error)
  __pyx_v_lava_reward = __pyx_t_1;
  __pyx_v_stone_reward = __pyx_t_1;
  __pyx_v_water_reward = __pyx_t_1;
  __pyx_v_enemy_reward = __pyx_t_1;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":56
 * 
 *    lava_reward = stone_reward = water_reward = enemy_reward = float('-inf')
 *    forest_reward = 1.0 + math.pow(             # <<<<<<<<<<<<<<
 *       (1 - entity.resources.food.val / entity.resources.food.max) * 15.0,
 ...
 */
  ...
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_pow); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":57
 *    lava_reward = stone_reward = water_reward = enemy_reward = float('-inf')
 *    forest_reward = 1.0 + math.pow(
 *       (1 - entity.resources.food.val / entity.resources.food.max) * 15.0,             # <<<<<<<<<<<<<<
 *       1.25)
 *    scrub_reward = 1.0
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_entity, __pyx_n_s_resources); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_food); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_val); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_entity, __pyx_n_s_resources); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_food); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_max); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyNumber_Divide(__pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_SubtractCObj(__pyx_int_1, __pyx_t_6, 1, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = PyNumber_Multiply(__pyx_t_5, __pyx_float_15_0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = NULL;
  __pyx_t_7 = 0;
  ...
  if (PyFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_t_6, __pyx_float_1_25};
    __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_7, 2+__pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 56, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_4)) {
    PyObject *__pyx_temp[3] = {__pyx_t_5, __pyx_t_6, __pyx_float_1_25};
    __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_4, __pyx_temp+1-__pyx_t_7, 2+__pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 56, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  } else
  #endif
  {
    __pyx_t_3 = PyTuple_New(2+__pyx_t_7); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 56, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (__pyx_t_5) {
    ...
    PyTuple_SET_ITEM(__pyx_t_3, 1+__pyx_t_7, __pyx_float_1_25);
    __pyx_t_6 = 0;
 ...
 *       1.25)
 */
  __pyx_t_4 = __Pyx_PyFloat_AddCObj(__pyx_float_1_0, __pyx_t_2, 1.0, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 56, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_forest_reward = __pyx_t_1;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":59
 *       (1 - entity.resources.food.val / entity.resources.food.max) * 15.0,
 *       1.25)
 *    scrub_reward = 1.0             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_scrub_reward = 1.0;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":60
 *       1.25)
 *    scrub_reward = 1.0
 *    around_water_reward = 1.0 + math.pow(             # <<<<<<<<<<<<<<
 *       (1 - entity.resources.water.val / entity.resources.water.max) * 15.0,
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_pow); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":61
 *    scrub_reward = 1.0
 *    around_water_reward = 1.0 + math.pow(
 *       (1 - entity.resources.water.val / entity.resources.water.max) * 15.0,             # <<<<<<<<<<<<<<
 *       1.25)
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_entity, __pyx_n_s_resources); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_water); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_val); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_v_entity, __pyx_n_s_resources); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_water); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_max); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_SubtractCObj(__pyx_int_1, __pyx_t_5, 1, 0, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = PyNumber_Multiply(__pyx_t_6, __pyx_float_15_0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = NULL;
  __pyx_t_7 = 0;
  ...
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[3] = {__pyx_t_6, __pyx_t_5, __pyx_float_1_25};
    __pyx_t_4 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_7, 2+__pyx_t_7); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 60, __pyx_L1_error)
  ...
  if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[3] = {__pyx_t_6, __pyx_t_5, __pyx_float_1_25};
    __pyx_t_4 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-__pyx_t_7, 2+__pyx_t_7); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_XDECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  } else
  #endif
  {
    __pyx_t_2 = PyTuple_New(2+__pyx_t_7); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (__pyx_t_6) {
    ...
    __Pyx_INCREF(__pyx_float_1_25);
    __Pyx_GIVEREF(__pyx_float_1_25);
    PyTuple_SET_ITEM(__pyx_t_2, 1+__pyx_t_7, __pyx_float_1_25);
    __pyx_t_5 = 0;
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 60, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  }
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 *       1.25)
 */
  __pyx_t_3 = __Pyx_PyFloat_AddCObj(__pyx_float_1_0, __pyx_t_4, 1.0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_1 = __pyx_PyFloat_AsDouble(__pyx_t_3); if (unlikely((__pyx_t_1 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_around_water_reward = __pyx_t_1;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":64
 *       1.25)
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_8 = PyObject_Length(__pyx_v_tiles); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 64, __pyx_L1_error)
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_t_8); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_tiles, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_8 = PyObject_Length(__pyx_t_2); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyInt_FromSsize_t(__pyx_t_8); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_float64); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_6) < 0) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_2, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_9 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_t_6, PyBUF_WRITABLE); if (unlikely(!__pyx_t_9.memview)) __PYX_ERR(0, 64, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_reward_matrix = __pyx_t_9;
  __pyx_t_9.memview = NULL;
  __pyx_t_9.data = NULL;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":66
 *    cdef double[:,:] reward_matrix = np.full((len(tiles), len(tiles[0])), 0.0, dtype=np.float64)
 * 
 *    for line in range(len(tiles)):             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_8 = PyObject_Length(__pyx_v_tiles); if (unlikely(__pyx_t_8 == ((Py_ssize_t)-1))) __PYX_ERR(0, 66, __pyx_L1_error)
  __pyx_t_10 = __pyx_t_8;
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_10; __pyx_t_7+=1) {
    __pyx_v_line = __pyx_t_7;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":67
 * 
 *    for line in range(len(tiles)):
 *       tile_line = tiles[line]             # <<<<<<<<<<<<<<
 *       for column in range(len(tile_line)):
 ...
 */
    __pyx_t_6 = __Pyx_GetItemInt(__pyx_v_tiles, __pyx_v_line, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 67, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_XDECREF_SET(__pyx_v_tile_line, __pyx_t_6);
    __pyx_t_6 = 0;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":68
 *    for line in range(len(tiles)):
 *       tile_line = tiles[line]
 *       for column in range(len(tile_line)):             # <<<<<<<<<<<<<<
 *          tile_val = tile_line[column].state.tex
 *          if tile_val == 'lava':
 */
    __pyx_t_11 = PyObject_Length(__pyx_v_tile_line); if (unlikely(__pyx_t_11 == ((Py_ssize_t)-1))) __PYX_ERR(0, 68, __pyx_L1_error)
    __pyx_t_12 = __pyx_t_11;
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      __pyx_v_column = __pyx_t_13;

      /* "forge/blade/systems/ai/dynamic_programming.pyx":69
 *       tile_line = tiles[line]
 *       for column in range(len(tile_line)):
 *          tile_val = tile_line[column].state.tex             # <<<<<<<<<<<<<<
 *          if tile_val == 'lava':
 ...
 */
      __pyx_t_6 = __Pyx_GetItemInt(__pyx_v_tile_line, __pyx_v_column, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 69, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_state); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 69, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_tex); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 69, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      if (!(likely(PyString_CheckExact(__pyx_t_6))||((__pyx_t_6) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "str", Py_TYPE(__pyx_t_6)->tp_name), 0))) __PYX_ERR(0, 69, __pyx_L1_error)
      __Pyx_XDECREF_SET(__pyx_v_tile_val, ((PyObject*)__pyx_t_6));
      __pyx_t_6 = 0;

      /* "forge/blade/systems/ai/dynamic_programming.pyx":70
 *       for column in range(len(tile_line)):
 *          tile_val = tile_line[column].state.tex
 *          if tile_val == 'lava':             # <<<<<<<<<<<<<<
 *             reward_matrix[line][column] += lava_reward
 * 
 */
      __pyx_t_14 = (__Pyx_PyString_Equals(__pyx_v_tile_val, __pyx_n_s_lava, Py_EQ)); if (unlikely(__pyx_t_14 < 0)) __PYX_ERR(0, 70, __pyx_L1_error)
      __pyx_t_15 = (__pyx_t_14 != 0);
      if (__pyx_t_15) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":71
 *          tile_val = tile_line[column].state.tex
 *          if tile_val == 'lava':
 *             reward_matrix[line][column] += lava_reward             # <<<<<<<<<<<<<<
 * 
 *          if tile_val == 'stone':
 */
        __pyx_t_16 = __pyx_v_line;
        __pyx_t_17 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_16 < 0) {
          __pyx_t_16 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_16 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_16 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_17 < 0) {
          __pyx_t_17 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_17 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_17 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 71, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_16 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_17 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_lava_reward;
 ...
 */
      ...
      /* "forge/blade/systems/ai/dynamic_programming.pyx":73
 *             reward_matrix[line][column] += lava_reward
 * 
 *          if tile_val == 'stone':             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_15 = (__Pyx_PyString_Equals(__pyx_v_tile_val, __pyx_n_s_stone, Py_EQ)); if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 73, __pyx_L1_error)
      __pyx_t_14 = (__pyx_t_15 != 0);
      if (__pyx_t_14) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":74
 * 
 *          if tile_val == 'stone':
 *             reward_matrix[line][column] += stone_reward             # <<<<<<<<<<<<<<
 * 
 *          if tile_val == 'forest':
 */
        __pyx_t_19 = __pyx_v_line;
        __pyx_t_20 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_19 < 0) {
          __pyx_t_19 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_19 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_19 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_20 < 0) {
          __pyx_t_20 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_20 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_20 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 74, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_19 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_20 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_stone_reward;
 ...
 */
      ...
      /* "forge/blade/systems/ai/dynamic_programming.pyx":76
 *             reward_matrix[line][column] += stone_reward
 * 
 *          if tile_val == 'forest':             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_14 = (__Pyx_PyString_Equals(__pyx_v_tile_val, __pyx_n_s_forest, Py_EQ)); if (unlikely(__pyx_t_14 < 0)) __PYX_ERR(0, 76, __pyx_L1_error)
      __pyx_t_15 = (__pyx_t_14 != 0);
      if (__pyx_t_15) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":77
 * 
 *          if tile_val == 'forest':
 *             reward_matrix[line][column] += forest_reward             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_22 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_22 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 77, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_21 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_22 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_forest_reward;
 ...
 */
      ...
      /* "forge/blade/systems/ai/dynamic_programming.pyx":79
 *             reward_matrix[line][column] += forest_reward
 * 
 *          if tile_val == 'water':             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_15 = (__Pyx_PyString_Equals(__pyx_v_tile_val, __pyx_n_s_water, Py_EQ)); if (unlikely(__pyx_t_15 < 0)) __PYX_ERR(0, 79, __pyx_L1_error)
      __pyx_t_14 = (__pyx_t_15 != 0);
      if (__pyx_t_14) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":80
 * 
 *          if tile_val == 'water':
 *             reward_matrix[line][column] += water_reward             # <<<<<<<<<<<<<<
 * 
 * 
 */
        __pyx_t_23 = __pyx_v_line;
        __pyx_t_24 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_23 < 0) {
          __pyx_t_23 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_23 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_23 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_24 < 0) {
          __pyx_t_24 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_24 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_24 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 80, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_23 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_24 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_water_reward;
 ...
 */
      ...
      /* "forge/blade/systems/ai/dynamic_programming.pyx":83
 * 
 * 
 ...
 * 
 */
      __pyx_t_6 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_has_water_around(__pyx_v_tiles, __pyx_v_line, __pyx_v_column); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 83, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_14 = __Pyx_PyObject_IsTrue(__pyx_t_6); if (unlikely(__pyx_t_14 < 0)) __PYX_ERR(0, 83, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      if (__pyx_t_14) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":84
 * 
 *          if has_water_around(tiles, line, column):
 *             reward_matrix[line][column] += around_water_reward             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_26 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_25 < 0) {
          __pyx_t_25 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_25 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_25 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_26 < 0) {
          __pyx_t_26 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_26 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_26 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 84, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_25 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_26 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_around_water_reward;
 ...
 */
      ...
      /* "forge/blade/systems/ai/dynamic_programming.pyx":86
 *             reward_matrix[line][column] += around_water_reward
 * 
 *          if tile_val == 'scrub':             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_14 = (__Pyx_PyString_Equals(__pyx_v_tile_val, __pyx_n_s_scrub, Py_EQ)); if (unlikely(__pyx_t_14 < 0)) __PYX_ERR(0, 86, __pyx_L1_error)
      __pyx_t_15 = (__pyx_t_14 != 0);
      if (__pyx_t_15) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":87
 * 
 *          if tile_val == 'scrub':
 *             reward_matrix[line][column] += scrub_reward             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_28 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_27 < 0) {
          __pyx_t_27 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_27 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_27 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_28 < 0) {
          __pyx_t_28 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_28 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_28 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 87, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_27 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_28 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_scrub_reward;
 ...
 */
      ...
      /* "forge/blade/systems/ai/dynamic_programming.pyx":89
 *             reward_matrix[line][column] += scrub_reward
 * 
 *          if len(tile_line[column].ents.values()) > 0:             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_t_5 = __Pyx_GetItemInt(__pyx_v_tile_line, __pyx_v_column, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 89, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_ents); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 89, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_values); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 89, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_t_2 = NULL;
      ...
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_29 = PyObject_Length(__pyx_t_6); if (unlikely(__pyx_t_29 == ((Py_ssize_t)-1))) __PYX_ERR(0, 89, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_15 = ((__pyx_t_29 > 0) != 0);
      if (__pyx_t_15) {

        /* "forge/blade/systems/ai/dynamic_programming.pyx":90
 * 
 *          if len(tile_line[column].ents.values()) > 0:
 *             reward_matrix[line][column] += enemy_reward             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_31 = __pyx_v_column;
        __pyx_t_18 = -1;
        if (__pyx_t_30 < 0) {
          __pyx_t_30 += __pyx_v_reward_matrix.shape[0];
          if (unlikely(__pyx_t_30 < 0)) __pyx_t_18 = 0;
        } else if (unlikely(__pyx_t_30 >= __pyx_v_reward_matrix.shape[0])) __pyx_t_18 = 0;
        if (__pyx_t_31 < 0) {
          __pyx_t_31 += __pyx_v_reward_matrix.shape[1];
          if (unlikely(__pyx_t_31 < 0)) __pyx_t_18 = 1;
        } else if (unlikely(__pyx_t_31 >= __pyx_v_reward_matrix.shape[1])) __pyx_t_18 = 1;
        if (unlikely(__pyx_t_18 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_18);
          __PYX_ERR(0, 90, __pyx_L1_error)
        }
        *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_reward_matrix.data + __pyx_t_30 * __pyx_v_reward_matrix.strides[0]) ) + __pyx_t_31 * __pyx_v_reward_matrix.strides[1]) )) += __pyx_v_enemy_reward;
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":92
 *             reward_matrix[line][column] += enemy_reward
 * 
 *    return reward_matrix             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __PYX_INC_MEMVIEW(&__pyx_v_reward_matrix, 0);
  __pyx_r = __pyx_v_reward_matrix;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.map_to_rewards", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
  if (unlikely(!__pyx_r.memview)) {
    PyErr_SetString(PyExc_TypeError, "Memoryview return value is not initialized");
  ...
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_tile_val);
  __PYX_XDEC_MEMVIEW(&__pyx_v_reward_matrix, 1);
  __Pyx_XDECREF(__pyx_v_tile_line);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_3map_to_rewards(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_3map_to_rewards(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_tiles = 0;
  PyObject *__pyx_v_entity = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("map_to_rewards (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_tiles,&__pyx_n_s_entity,0};
    PyObject* values[2] = {0,0};
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_entity)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("map_to_rewards", 1, 2, 2, 1); __PYX_ERR(0, 50, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "map_to_rewards") < 0)) __PYX_ERR(0, 50, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("map_to_rewards", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 50, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.map_to_rewards", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_2map_to_rewards(__pyx_self, __pyx_v_tiles, __pyx_v_entity);
...
static PyObject *__pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_2map_to_rewards(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_tiles, PyObject *__pyx_v_entity) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_memviewslice __pyx_t_1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_t_2 = NULL;
  __Pyx_RefNannySetupContext("map_to_rewards", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_map_to_rewards(__pyx_v_tiles, __pyx_v_entity, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 50, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 50, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __PYX_XDEC_MEMVIEW(&__pyx_t_1, 1);
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;
...
/* "forge/blade/systems/ai/dynamic_programming.pyx":94
 *    return reward_matrix
 * 
 * cpdef tuple max_value_direction_around(int line, int column, double[:,:] value_matrix):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_5max_value_direction_around(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_max_value_direction_around(int __pyx_v_line, int __pyx_v_column, __Pyx_memviewslice __pyx_v_value_matrix, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_max_value;
  int __pyx_v_horizontal_dir;
  int __pyx_v_vertical_dir;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  int __pyx_t_2;
  ...
  __Pyx_RefNannySetupContext("max_value_direction_around", 0);

  /* "forge/blade/systems/ai/dynamic_programming.pyx":95
 * 
 * cpdef tuple max_value_direction_around(int line, int column, double[:,:] value_matrix):
 *    cdef double max_value = float('-inf')             # <<<<<<<<<<<<<<
 *    cdef int horizontal_dir, vertical_dir
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_AsDouble(__pyx_kp_s_inf_2); if (unlikely(__pyx_t_1 == ((double)((double)-1)) && PyErr_Occurred())) __PYX_ERR(0, 95, __pyx_L1_error)
  __pyx_v_max_value = __pyx_t_1;

  /* "forge/blade/systems/ai/dynamic_programming.pyx":98
 *    cdef int horizontal_dir, vertical_dir
 * 
 ...
 *       horizontal_dir = -1
 */
  __pyx_t_3 = (((__pyx_v_line - 1) >= 0) != 0);
  if (__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_4 = (__pyx_v_line - 1);
  __pyx_t_5 = __pyx_v_column;
  __pyx_t_6 = -1;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_v_value_matrix.shape[0];
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_4 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_value_matrix.shape[1];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 98, __pyx_L1_error)
  }
  __pyx_t_3 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_4 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_5 * __pyx_v_value_matrix.strides[1]) ))) > __pyx_v_max_value) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L4_bool_binop_done:;
  if (__pyx_t_2) {

    /* "forge/blade/systems/ai/dynamic_programming.pyx":99
 * 
 *    if line - 1 >= 0 and value_matrix[line - 1][column] > max_value :
 *       max_value = value_matrix[line - 1][column]             # <<<<<<<<<<<<<<
 *       horizontal_dir = -1
 *       vertical_dir = 0
 */
    __pyx_t_7 = (__pyx_v_line - 1);
    __pyx_t_8 = __pyx_v_column;
    __pyx_t_6 = -1;
    if (__pyx_t_7 < 0) {
      __pyx_t_7 += __pyx_v_value_matrix.shape[0];
      if (unlikely(__pyx_t_7 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_7 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
    if (__pyx_t_8 < 0) {
      __pyx_t_8 += __pyx_v_value_matrix.shape[1];
      if (unlikely(__pyx_t_8 < 0)) __pyx_t_6 = 1;
    } else if (unlikely(__pyx_t_8 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 99, __pyx_L1_error)
    }
    __pyx_v_max_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_7 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_8 * __pyx_v_value_matrix.strides[1]) )));

    /* "forge/blade/systems/ai/dynamic_programming.pyx":100
 *    if line - 1 >= 0 and value_matrix[line - 1][column] > max_value :
 *       max_value = value_matrix[line - 1][column]
 *       horizontal_dir = -1             # <<<<<<<<<<<<<<
 *       vertical_dir = 0
 * 
 */
    __pyx_v_horizontal_dir = -1;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":101
 *       max_value = value_matrix[line - 1][column]
 *       horizontal_dir = -1
 *       vertical_dir = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":103
 *       vertical_dir = 0
 * 
 *    if line + 1 < len(value_matrix) and value_matrix[line + 1][column] > max_value :             # <<<<<<<<<<<<<<
 *       max_value = value_matrix[line + 1][column]
 *       horizontal_dir = 1
 */
  __pyx_t_9 = __Pyx_MemoryView_Len(__pyx_v_value_matrix); 
  __pyx_t_3 = (((__pyx_v_line + 1) < __pyx_t_9) != 0);
  if (__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
    goto __pyx_L7_bool_binop_done;
  }
  __pyx_t_10 = (__pyx_v_line + 1);
  __pyx_t_11 = __pyx_v_column;
  __pyx_t_6 = -1;
  if (__pyx_t_10 < 0) {
    __pyx_t_10 += __pyx_v_value_matrix.shape[0];
    if (unlikely(__pyx_t_10 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_10 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
  if (__pyx_t_11 < 0) {
    __pyx_t_11 += __pyx_v_value_matrix.shape[1];
    if (unlikely(__pyx_t_11 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_11 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 103, __pyx_L1_error)
  }
  __pyx_t_3 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_10 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_11 * __pyx_v_value_matrix.strides[1]) ))) > __pyx_v_max_value) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L7_bool_binop_done:;
  if (__pyx_t_2) {

    /* "forge/blade/systems/ai/dynamic_programming.pyx":104
 * 
 *    if line + 1 < len(value_matrix) and value_matrix[line + 1][column] > max_value :
 *       max_value = value_matrix[line + 1][column]             # <<<<<<<<<<<<<<
 *       horizontal_dir = 1
 *       vertical_dir = 0
 */
    __pyx_t_12 = (__pyx_v_line + 1);
    __pyx_t_13 = __pyx_v_column;
    __pyx_t_6 = -1;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_value_matrix.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_value_matrix.shape[1];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_6 = 1;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 104, __pyx_L1_error)
    }
    __pyx_v_max_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_12 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_13 * __pyx_v_value_matrix.strides[1]) )));

    /* "forge/blade/systems/ai/dynamic_programming.pyx":105
 *    if line + 1 < len(value_matrix) and value_matrix[line + 1][column] > max_value :
 *       max_value = value_matrix[line + 1][column]
 *       horizontal_dir = 1             # <<<<<<<<<<<<<<
 *       vertical_dir = 0
 ...
 */
    ...
    /* "forge/blade/systems/ai/dynamic_programming.pyx":106
 *       max_value = value_matrix[line + 1][column]
 *       horizontal_dir = 1
 *       vertical_dir = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":109
 * 
 * 
 ...
 *       horizontal_dir = 0
 */
  __pyx_t_3 = (((__pyx_v_column - 1) >= 0) != 0);
  if (__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
  ...
  __pyx_t_15 = (__pyx_v_column - 1);
  __pyx_t_6 = -1;
  if (__pyx_t_14 < 0) {
    __pyx_t_14 += __pyx_v_value_matrix.shape[0];
    if (unlikely(__pyx_t_14 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_14 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
  if (__pyx_t_15 < 0) {
    __pyx_t_15 += __pyx_v_value_matrix.shape[1];
    if (unlikely(__pyx_t_15 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_15 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 109, __pyx_L1_error)
  }
  __pyx_t_3 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_14 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_15 * __pyx_v_value_matrix.strides[1]) ))) > __pyx_v_max_value) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L10_bool_binop_done:;
  if (__pyx_t_2) {

    /* "forge/blade/systems/ai/dynamic_programming.pyx":110
 * 
 *    if column - 1 >= 0 and value_matrix[line][column-1] > max_value :
 *       max_value = value_matrix[line][column-1]             # <<<<<<<<<<<<<<
 *       horizontal_dir = 0
 ...
 */
    __pyx_t_16 = __pyx_v_line;
    __pyx_t_17 = (__pyx_v_column - 1);
    __pyx_t_6 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_value_matrix.shape[0];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_6 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
    if (__pyx_t_17 < 0) {
      __pyx_t_17 += __pyx_v_value_matrix.shape[1];
      if (unlikely(__pyx_t_17 < 0)) __pyx_t_6 = 1;
    } else if (unlikely(__pyx_t_17 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
    if (unlikely(__pyx_t_6 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_6);
      __PYX_ERR(0, 110, __pyx_L1_error)
    }
    __pyx_v_max_value = (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_16 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_17 * __pyx_v_value_matrix.strides[1]) )));

    /* "forge/blade/systems/ai/dynamic_programming.pyx":111
 *    if column - 1 >= 0 and value_matrix[line][column-1] > max_value :
 *       max_value = value_matrix[line][column-1]
 *       horizontal_dir = 0             # <<<<<<<<<<<<<<
 *       vertical_dir = -1
 * 
 */
    __pyx_v_horizontal_dir = 0;

    /* "forge/blade/systems/ai/dynamic_programming.pyx":112
 *       max_value = value_matrix[line][column-1]
 *       horizontal_dir = 0
 *       vertical_dir = -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":114
 *       vertical_dir = -1
 * 
 *    if column + 1<len(value_matrix[0]) and value_matrix[line][column+1] > max_value :             # <<<<<<<<<<<<<<
 *       horizontal_dir = 0
 *       vertical_dir = 1
 */
  __pyx_t_18.data = __pyx_v_value_matrix.data;
  __pyx_t_18.memview = __pyx_v_value_matrix.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_18, 0);
  {
    Py_ssize_t __pyx_tmp_idx = 0;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_value_matrix.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_value_matrix.strides[0];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape)) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_18.shape[0] = __pyx_v_value_matrix.shape[1];
__pyx_t_18.strides[0] = __pyx_v_value_matrix.strides[1];
    __pyx_t_18.suboffsets[0] = -1;

__pyx_t_9 = __Pyx_MemoryView_Len(__pyx_t_18); 
  __PYX_XDEC_MEMVIEW(&__pyx_t_18, 1);
  __pyx_t_18.memview = NULL;
  __pyx_t_18.data = NULL;
  __pyx_t_3 = (((__pyx_v_column + 1) < __pyx_t_9) != 0);
  if (__pyx_t_3) {
  } else {
    __pyx_t_2 = __pyx_t_3;
  ...
  __pyx_t_19 = __pyx_v_line;
  __pyx_t_20 = (__pyx_v_column + 1);
  __pyx_t_6 = -1;
  if (__pyx_t_19 < 0) {
    __pyx_t_19 += __pyx_v_value_matrix.shape[0];
    if (unlikely(__pyx_t_19 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_19 >= __pyx_v_value_matrix.shape[0])) __pyx_t_6 = 0;
  if (__pyx_t_20 < 0) {
    __pyx_t_20 += __pyx_v_value_matrix.shape[1];
    if (unlikely(__pyx_t_20 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_20 >= __pyx_v_value_matrix.shape[1])) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 114, __pyx_L1_error)
  }
  __pyx_t_3 = (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_value_matrix.data + __pyx_t_19 * __pyx_v_value_matrix.strides[0]) ) + __pyx_t_20 * __pyx_v_value_matrix.strides[1]) ))) > __pyx_v_max_value) != 0);
  __pyx_t_2 = __pyx_t_3;
  __pyx_L13_bool_binop_done:;
  if (__pyx_t_2) {

    /* "forge/blade/systems/ai/dynamic_programming.pyx":115
 * 
 *    if column + 1<len(value_matrix[0]) and value_matrix[line][column+1] > max_value :
 *       horizontal_dir = 0             # <<<<<<<<<<<<<<
 *       vertical_dir = 1
 ...
 */
    ...
    /* "forge/blade/systems/ai/dynamic_programming.pyx":116
 *    if column + 1<len(value_matrix[0]) and value_matrix[line][column+1] > max_value :
 *       horizontal_dir = 0
 *       vertical_dir = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":118
 *       vertical_dir = 1
 * 
 *    return horizontal_dir, vertical_dir             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_21 = __Pyx_PyInt_From_int(__pyx_v_horizontal_dir); if (unlikely(!__pyx_t_21)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_21);
  __pyx_t_22 = __Pyx_PyInt_From_int(__pyx_v_vertical_dir); if (unlikely(!__pyx_t_22)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_22);
  __pyx_t_23 = PyTuple_New(2); if (unlikely(!__pyx_t_23)) __PYX_ERR(0, 118, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.max_value_direction_around", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_5max_value_direction_around(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_5max_value_direction_around(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_line;
  int __pyx_v_column;
  __Pyx_memviewslice __pyx_v_value_matrix = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("max_value_direction_around (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_line,&__pyx_n_s_column,&__pyx_n_s_value_matrix,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_column)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("max_value_direction_around", 1, 3, 3, 1); __PYX_ERR(0, 94, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_value_matrix)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("max_value_direction_around", 1, 3, 3, 2); __PYX_ERR(0, 94, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "max_value_direction_around") < 0)) __PYX_ERR(0, 94, __pyx_L3_error)
      }
    ...
    __pyx_v_line = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_line == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 94, __pyx_L3_error)
    __pyx_v_column = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_column == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 94, __pyx_L3_error)
    __pyx_v_value_matrix = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_value_matrix.memview)) __PYX_ERR(0, 94, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("max_value_direction_around", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 94, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.max_value_direction_around", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_4max_value_direction_around(__pyx_self, __pyx_v_line, __pyx_v_column, __pyx_v_value_matrix);
...
static PyObject *__pyx_pf_5forge_5blade_7systems_2ai_19dynamic_programming_4max_value_direction_around(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_line, int __pyx_v_column, __Pyx_memviewslice __pyx_v_value_matrix) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("max_value_direction_around", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_value_matrix.memview)) { __Pyx_RaiseUnboundLocalError("value_matrix"); __PYX_ERR(0, 94, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_max_value_direction_around(__pyx_v_line, __pyx_v_column, __pyx_v_value_matrix, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
...
/* "forge/blade/systems/ai/dynamic_programming.pyx":121
 * 
 * 
...
static PyObject *__pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_has_water_around(PyObject *__pyx_v_tiles, int __pyx_v_line, int __pyx_v_column) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  int __pyx_t_4;
  PyObject *__pyx_t_5 = NULL;
  __Pyx_RefNannySetupContext("has_water_around", 0);

  /* "forge/blade/systems/ai/dynamic_programming.pyx":122
 * 
 * cdef has_water_around(tiles, int line, int column):
 *    return (inBounds(line-1, column, tiles.shape) and tiles[line-1, column].state.tex is 'water') or \             # <<<<<<<<<<<<<<
 *           (inBounds(line, column-1, tiles.shape) and tiles[line, column-1].state.tex is 'water') or \
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_tiles, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 122, __pyx_L1_error)
  __pyx_t_3 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_inBounds((__pyx_v_line - 1), __pyx_v_column, ((PyObject*)__pyx_t_2)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_line - 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_column); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_3 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_v_tiles, __pyx_t_5); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_state); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_tex); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 122, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_4 = (__pyx_t_2 == __pyx_n_s_water);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!__pyx_t_4) {
  } else {
    __pyx_t_2 = __Pyx_PyBool_FromLong(__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 122, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":123
 * cdef has_water_around(tiles, int line, int column):
 *    return (inBounds(line-1, column, tiles.shape) and tiles[line-1, column].state.tex is 'water') or \
 *           (inBounds(line, column-1, tiles.shape) and tiles[line, column-1].state.tex is 'water') or \             # <<<<<<<<<<<<<<
 *           (inBounds(line+1, column, tiles.shape) and tiles[line+1, column].state.tex is 'water') or \
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_tiles, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 123, __pyx_L1_error)
  __pyx_t_5 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_inBounds(__pyx_v_line, (__pyx_v_column - 1), ((PyObject*)__pyx_t_2)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_line); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_column - 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_5 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_v_tiles, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_state); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_tex); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = (__pyx_t_2 == __pyx_n_s_water);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!__pyx_t_4) {
    ...
    __pyx_t_2 = __Pyx_PyBool_FromLong(__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 123, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L3_bool_binop_done;
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":124
 *    return (inBounds(line-1, column, tiles.shape) and tiles[line-1, column].state.tex is 'water') or \
 *           (inBounds(line, column-1, tiles.shape) and tiles[line, column-1].state.tex is 'water') or \
 *           (inBounds(line+1, column, tiles.shape) and tiles[line+1, column].state.tex is 'water') or \             # <<<<<<<<<<<<<<
 *           (inBounds(line, column+1, tiles.shape) and tiles[line, column+1].state.tex is 'water')
 * 
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_tiles, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 124, __pyx_L1_error)
  __pyx_t_3 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_inBounds((__pyx_v_line + 1), __pyx_v_column, ((PyObject*)__pyx_t_2)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_line + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_column); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_3 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_v_tiles, __pyx_t_5); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_state); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_tex); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_4 = (__pyx_t_2 == __pyx_n_s_water);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (!__pyx_t_4) {
    ...
    __pyx_t_2 = __Pyx_PyBool_FromLong(__pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 124, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_1 = __pyx_t_2;
    __pyx_t_2 = 0;
    goto __pyx_L3_bool_binop_done;
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":125
 *           (inBounds(line, column-1, tiles.shape) and tiles[line, column-1].state.tex is 'water') or \
 *           (inBounds(line+1, column, tiles.shape) and tiles[line+1, column].state.tex is 'water') or \
 *           (inBounds(line, column+1, tiles.shape) and tiles[line, column+1].state.tex is 'water')             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_tiles, __pyx_n_s_shape); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (!(likely(PyTuple_CheckExact(__pyx_t_2))||((__pyx_t_2) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_t_2)->tp_name), 0))) __PYX_ERR(0, 125, __pyx_L1_error)
  __pyx_t_5 = __pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_inBounds(__pyx_v_line, (__pyx_v_column + 1), ((PyObject*)__pyx_t_2)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_4 < 0)) __PYX_ERR(0, 125, __pyx_L1_error)
  if (__pyx_t_4) {
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  } else {
    __Pyx_INCREF(__pyx_t_5);
  ...
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_line); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_column + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_5 = 0;
  __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetItem(__pyx_v_tiles, __pyx_t_3); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_state); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_tex); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 125, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_4 = (__pyx_t_2 == __pyx_n_s_water);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_3);
  __Pyx_XDECREF(__pyx_t_5);
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.has_water_around", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* "forge/blade/systems/ai/dynamic_programming.pyx":127
 *           (inBounds(line, column+1, tiles.shape) and tiles[line, column+1].state.tex is 'water')
 * 
 * cdef inBounds(int r, int c, tuple shape):             # <<<<<<<<<<<<<<
 *    cdef int R, C
...
static PyObject *__pyx_f_5forge_5blade_7systems_2ai_19dynamic_programming_inBounds(int __pyx_v_r, int __pyx_v_c, PyObject *__pyx_v_shape) {
  int __pyx_v_R;
  int __pyx_v_C;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":129
 * cdef inBounds(int r, int c, tuple shape):
 *    cdef int R, C
 *    R, C = shape             # <<<<<<<<<<<<<<
 *    return (
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyInt_As_int(__pyx_t_1); if (unlikely((__pyx_t_3 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 129, __pyx_L1_error)
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":130
 *    cdef int R, C
 *    R, C = shape
 *    return (             # <<<<<<<<<<<<<<
 *          r > 0 and
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":131
 *    R, C = shape
 *    return (
 *          r > 0 and             # <<<<<<<<<<<<<<
 *          c > 0 and
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":132
 *    return (
 *          r > 0 and
 *          c > 0 and             # <<<<<<<<<<<<<<
 *          r < R and
 ...
 */
  ...
  if (__pyx_t_5) {
    ...
    __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 132, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __pyx_t_1;
    __pyx_t_1 = 0;
    goto __pyx_L3_bool_binop_done;
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":133
 *          r > 0 and
 *          c > 0 and
 *          r < R and             # <<<<<<<<<<<<<<
 *          c < C
 *          )
 */
  __pyx_t_5 = (__pyx_v_r < __pyx_v_R);
  if (__pyx_t_5) {
  } else {
    __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 133, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_2 = __pyx_t_1;
    __pyx_t_1 = 0;
    goto __pyx_L3_bool_binop_done;
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":134
 *          c > 0 and
 *          r < R and
 *          c < C             # <<<<<<<<<<<<<<
 *          )
 */
  __pyx_t_5 = (__pyx_v_c < __pyx_v_C);
  __pyx_t_1 = __Pyx_PyBool_FromLong(__pyx_t_5); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 134, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __pyx_t_1;
  __pyx_t_1 = 0;
  __pyx_L3_bool_binop_done:;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_AddTraceback("forge.blade.systems.ai.dynamic_programming.inBounds", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "forge.blade.systems.ai.dynamic_programming.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "forge.blade.systems.ai.dynamic_programming.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "forge.blade.systems.ai.dynamic_programming.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "forge.blade.systems.ai.dynamic_programming._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"compute_values", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_1compute_values, METH_VARARGS|METH_KEYWORDS, 0},
  {"map_to_rewards", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_3map_to_rewards, METH_VARARGS|METH_KEYWORDS, 0},
  {"max_value_direction_around", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5forge_5blade_7systems_2ai_19dynamic_programming_5max_value_direction_around, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_dynamic_programming(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_dynamic_programming},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_value_matrix, __pyx_k_value_matrix, sizeof(__pyx_k_value_matrix), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initdynamic_programming(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initdynamic_programming(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_dynamic_programming(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_dynamic_programming(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_dynamic_programming(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'dynamic_programming' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_dynamic_programming(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("dynamic_programming", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_forge__blade__systems__ai__dynamic_programming) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "forge.blade.systems.ai.dynamic_programming")) {
      if (unlikely(PyDict_SetItemString(modules, "forge.blade.systems.ai.dynamic_programming", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":2
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 * import math
 * 
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":3
 * cimport numpy as np
 * import numpy as np
 * import math             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "forge/blade/systems/ai/dynamic_programming.pyx":1
 * cimport numpy as np             # <<<<<<<<<<<<<<
 * import numpy as np
 * import math
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init forge.blade.systems.ai.dynamic_programming", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init forge.blade.systems.ai.dynamic_programming");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
